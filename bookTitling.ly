...
\paper {
  bookTitleMarkup = \markup \when-property #'header:title \column {
    \combine \null \vspace #3
    \fill-line { \fontsize #2 \italic \fromproperty #'header:composer }
    \combine \null \vspace #1
    \fill-line { \fontsize #2 \italic \fromproperty #'header:poet }
    \combine \null \vspace #3
    \fill-line { \fontsize #5 \fromproperty #'header:title }
    \combine \null \vspace #3
    \fill-line { \postscript #"-20 0 moveto 40 0 rlineto stroke" }
    \combine \null \vspace #3
    \fill-line { \fontsize #2 \fromproperty #'header:date }
    \combine \null \vspace #1 
    \fill-line {
      \when-property #'header:arrangement \column {
        \combine \null \vspace #2
        \fill-line { \fontsize #1 \fromproperty #'header:arrangement }
      }
    }
  }
...
\paper {
  tocTitleMarkup = \markup \column {
    \combine \null \vspace #2
    \fontsize #3 \fill-line { \paper-prop #'tocTitle "TABLE OF CONTENTS" }
    \combine \null \vspace #0.5
  }
  tocPieceMarkup = \markup \fill-line {
    \line-width-ratio #0.7 \fill-line {
      \line { \fontsize #-0.5 \fromproperty #'toc:text }
      \fromproperty #'toc:page
    }
  }
  tocSectionMarkup = \markup \italic \column {
    \fill-line { \fontsize #-1 \fromproperty #'toc:text }
  }
  tocChapterMarkup = \markup \large \italic \column {
    \combine \null \vspace #-0.5
    \fontsize #0.5 \fill-line { \fromproperty #'toc:text }
    \combine \null \vspace #-0.5
  }
}
